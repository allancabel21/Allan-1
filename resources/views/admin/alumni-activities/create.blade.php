...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('admin.alumni-activities.store') }}" method="POST" enctype="multipart/form-data" id="activityForm">
            @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="file" id="image" name="image" accept="image/*"
                               class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <p class="text-xs text-gray-500 mt-1">Upload an image for this activity (optional)</p>
                        @error('image')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
...
function autoSave() {
    ...
    autoSaveTimeout = setTimeout(() => {
        ...
        fetch('{{ route("admin.alumni-activities.store") }}', {
            method: 'POST',
            body: formData
        })
