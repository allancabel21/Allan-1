...
<div class="p-6">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Create a new announcement for graduates</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
        <form action="{{ route('admin.announcements.store') }}" method="POST" class="p-8">
            @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors @error('target_audience') border-red-500 @enderror" 
                            ...
                            <option value="graduates" {{ old('target_audience') == 'graduates' ? 'selected' : '' }}>Graduates Only</option>
