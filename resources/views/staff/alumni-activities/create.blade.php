...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center mb-4">
            <a href="{{ route('staff.alumni-activities') }}" class="text-blue-600 hover:text-blue-800 mr-4">
                <i class="fas fa-arrow-left"></i>
            </a>
            <h1 class="text-3xl font-bold text-gray-900">Create Alumni Activity</h1>
        </div>
        <p class="text-gray-600">Create a new alumni event, reunion, or mentorship program</p>
    </div>

    <!-- Form -->
    <div class="bg-white rounded-lg shadow p-6">
        <form action="{{ route('staff.alumni-activities.store') }}" method="POST">
            @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="type" name="type" required
                            ...
                            <option value="homecoming" {{ old('type') === 'homecoming' ? 'selected' : '' }}>Annual Homecoming</option>
                            <option value="reunion" {{ old('type') === 'reunion' ? 'selected' : '' }}>Batch Reunion</option>
                            <option value="mentorship" {{ old('type') === 'mentorship' ? 'selected' : '' }}>Mentorship Session</option>
                    ...
                    <div id="batch-year-field" style="display: none;">
                        <label for="batch_year" class="block text-sm font-medium text-gray-700 mb-2">Batch Year</label>
                        <input type="text" id="batch_year" name="batch_year" value="{{ old('batch_year') }}" placeholder="e.g., 2020"
                               class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        @error('batch_year')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
            ...
            <div class="mt-8 space-y-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" id="registration_fee" name="registration_fee" value="{{ old('registration_fee', 0) }}" min="0" step="0.01"
                               class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div class="mt-8 flex justify-end space-x-4">
                <a href="{{ route('staff.alumni-activities') }}" class="bg-gray-300 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-400 transition-colors">
                    Cancel
                </a>
