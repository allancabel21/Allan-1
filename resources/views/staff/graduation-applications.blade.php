...
function viewApplication(applicationId) {
    ...
    fetch(`/staff/graduation-applications/${applicationId}`)
...
function approveApplication(applicationId) {
    currentApplicationId = applicationId;
    document.getElementById('approvalForm').action = `/staff/graduation-applications/${applicationId}/approve`;
...
function rejectApplication(applicationId) {
    currentApplicationId = applicationId;
    document.getElementById('rejectionForm').action = `/staff/graduation-applications/${applicationId}/reject`;
